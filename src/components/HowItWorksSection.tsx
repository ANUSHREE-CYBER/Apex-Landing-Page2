...
const HowItWorksSection = ({ locale = 'en' }: HowItWorksSectionProps) => {
  ...
  // Progress line width: 25% per step
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive 
                      ? 'bg-[hsl(250,45%,15%)]' 
                      : 'bg-transparent hover:bg-[hsl(250,45%,12%)]'
                    }
                ...
                >
                  <div className="flex items-start gap-4 md:gap-6">
                    ...
                    <div className="flex-1">
                      <h3 
                        className={`
                          text-lg md:text-xl lg:text-2xl font-bold transition-colors duration-300
                          ${isActive ? '' : 'text-white'}
                        `}
                        style={{ 
                          color: isActive ? '#C0FF3B' : undefined,
                          fontFamily: 'Poppins'
                        }}
                      >
                        {step.title}
                      ...
                      {/* Progress line - only show for active step */}
                      {isActive && (
                        <div className="mt-4 h-1 w-full bg-[hsl(250,45%,20%)] rounded-full overflow-hidden">
                          {/* 
                            PROGRESS LINE ANIMATION
                            To change animation duration: modify 'duration-500' below
                            Options: duration-300 (fast), duration-500 (medium), duration-700 (slow)
                          */}
                          <div 
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            {/* 
              STORE IMAGE
              To adjust size: change max-w-[500px] to max-w-[400px] or max-w-[600px]
              To adjust position: add translate-x-4, -translate-y-6, etc.
            */}
            <div className="relative w-full max-w-[500px] rounded-[20px] overflow-hidden shadow-2xl">
              <img 
                src={storeImage} 
                alt={locale === 'hi' ? 'स्मार्ट वैल्यू स्टोर' : 'Smart Value Store'}
