...
const translations = {
  ...
  hi: {
    ...
    tradeIn: "ट्रेड-इन",
    journeyToday: "सफर आज",
    description: "स्मार्ट वैल्यू में, हम अपग्रेड अनुभव को फिर से परिभाषित कर रहे हैं।",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10 max-w-5xl mx-auto">
          <ScrollReveal direction="up" delay={0.1}>
            <div className="flex justify-center">
              <FeatureCard icon={shieldIcon} title={t.trustedTradeIn} alt="Trusted trade-in shield icon" />
            </div>
          </ScrollReveal>
          <ScrollReveal direction="up" delay={0.25}>
            <div className="flex justify-center">
              <FeatureCard icon={flashIcon} title={t.instantValue} alt="Instant value lightning icon" />
            </div>
          </ScrollReveal>
          <ScrollReveal direction="up" delay={0.4}>
            <div className="flex justify-center">
              <FeatureCard icon={recycleIcon} title={t.ecoFriendly} alt="Eco friendly recycle icon" />
            </div>
          </ScrollReveal>
        </div>
